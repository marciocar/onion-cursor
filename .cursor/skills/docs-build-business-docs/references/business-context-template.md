...
- Use kebab-case for all documentation files (e.g., `01-customer/personas.md`)
- Organize by numbered layer folders (`01-customer/`, `02-product/`, etc.)
...
- [Customer Personas](01-customer/personas.md)
- [Customer Journey](01-customer/journey.md)
- [Voice of Customer](01-customer/voice-of-customer.md)

## Layer 2: Product Context Architecture

- [Product Strategy](02-product/strategy.md)
- [Feature Catalog](02-product/features/<feature>.md)
- [Product Metrics](02-product/metrics.md)

## Layer 3: Market and Competitive Context

- [Competitive Landscape](03-market/competitive-landscape.md)
- [Industry Trends](03-market/industry-trends.md)

## Layer 4: Operational Business Context

- [Sales Process](04-operations/sales-process.md)
- [Messaging Framework](04-operations/messaging-framework.md)
- [Customer Communication Guidelines](04-operations/customer-communication.md)
...
**Create: `01-customer/personas.md`**
```markdown
# Customer Personas
...
**Create: `01-customer/voice-of-customer.md`**
```markdown
...
**Create: `02-product/features/<feature>.md`**
```markdown
# Feature Catalog
...
**Create: `03-market/competitive-landscape.md` (CONDITIONAL)**
```markdown
Required if:
...
**Create: `03-market/industry-trends.md`**
```markdown
...
**Create: `04-operations/sales-process.md`**
```markdown
...
**Create: `04-operations/messaging-framework.md`**
```markdown
...
**Create: `04-operations/customer-communication.md`**
```markdown
...
```markdown
File: `/business-context/measurement/measurement/quality-metrics.md`
...
/specs/business/                 # or /docs/business-context/
  ...
  01-customer/personas.md          # Layer 1: Customer intelligence
  01-customer/journey.md           # Layer 1: Customer lifecycle
  01-customer/voice-of-customer.md          # Layer 1: Customer feedback
  02-product/strategy.md           # Layer 2: Product context
  02-product/features/<feature>.md            # Layer 2: Feature details
  02-product/metrics.md            # Layer 2: Performance data
  03-market/competitive-landscape.md      # Layer 3: Market intelligence
  03-market/industry-trends.md            # Layer 3: Market evolution
  04-operations/sales-process.md              # Layer 4: Sales methodology
  04-operations/messaging-framework.md        # Layer 4: Brand guidelines
  04-operations/customer-communication.md     # Layer 4: AI interaction guide
```
