...
Ação:
  ...
  - Carregar informações do segmento (01-customer/personas.md)
  - Carregar jornada do cliente (01-customer/journey.md)
...
Ação:
  ...
  - Carregar contexto de produto (02-product/strategy.md)
  - Carregar processo de vendas (04-operations/sales-process.md)
...
Ação:
  ...
  - Carregar contexto competitivo (03-market/competitive-landscape.md)
...
- `docs/business-context/01-customer/personas.md` - Para entender segmentos
- `docs/business-context/01-customer/journey.md` - Para entender jornada
- `docs/business-context/01-customer/voice-of-customer.md` - Para entender feedback
- `docs/business-context/02-product/strategy.md` - Para entender estratégia
- `docs/business-context/04-operations/sales-process.md` - Para entender vendas
- `docs/business-context/03-market/competitive-landscape.md` - Para benchmarking
...
2. Carrega informações do segmento (01-customer/personas.md)
...
2. **Contexto Carregado:**
   - 01-customer/personas.md → Persona: CEO Startup
   - 01-customer/journey.md → Etapa: Preparação para investimento
   - 01-customer/voice-of-customer.md → Padrões de feedback
   - 04-operations/sales-process.md → Processo de vendas
...
2. **Contexto Carregado:**
   - 02-product/strategy.md → Estratégia atual
   - 04-operations/sales-process.md → Processo de vendas
   - 01-customer/personas.md → Personas de startups
   - 03-market/competitive-landscape.md → Preços da concorrência
3. **Análise Preparada:**
...
**Contexto de Negócio:**
- `docs/business-context/01-customer/personas.md`
- `docs/business-context/01-customer/journey.md`
- `docs/business-context/01-customer/voice-of-customer.md`
- `docs/business-context/02-product/strategy.md`
- `docs/business-context/04-operations/sales-process.md`
- `docs/business-context/03-market/competitive-landscape.md`
