...
- Use kebab-case for all documentation files (e.g., `02-ai-context/codebase-guide.md`)
- Organize by numbered layer folders (`01-core/`, `02-ai-context/`, etc.)
...
- [Project Charter](01-core/project-charter.md)
- [Architecture Decision Records](01-core/adr/)

## Layer 2: AI-Optimized Context Files

- [AI Development Guide](02-ai-context/ai-development-guide.md) - Example CLAUDE CODE.md file for project level  
- [Codebase Navigation Guide](02-ai-context/codebase-guide.md)

## Layer 3: Domain-Specific Context

- [Business Logic Documentation](03-domain/business-logic.md)
- [API Specifications](03-domain/api-specification.md)

## Layer 4: Development Workflow Context

- [Development Workflow Guide](04-workflow/contributing.md)
- [Troubleshooting Guide](04-workflow/troubleshooting.md)
...
**Create: `01-core/project-charter.md`**
```markdown
...
**Create: `01-core/adr/` directory with individual ADR files**
```markdown
...
**Create: `02-ai-context/ai-development-guide.md` (AI Development Guide)**
```markdown
...
**Create: `02-ai-context/codebase-guide.md`**
```markdown
...
**Create: `03-domain/business-logic.md` (CONDITIONAL)**
```markdown
Required if:
...
**Create: `03-domain/api-specification.md` (CONDITIONAL)**
```markdown
Required if:
...
**Create: `04-workflow/contributing.md` (Development Workflow Guide)**
```markdown
...
**Create: `04-workflow/troubleshooting.md`**
```markdown
...
/specs/technical/               # or /docs/context/
  ...
  01-core/project-charter.md           # Layer 1: Core context
  /adr/                        # Layer 1: Architecture decisions
    001-database-choice.md
    002-authentication-strategy.md
  02-ai-context/ai-development-guide.md  # Layer 2: AI development guide
  02-ai-context/codebase-guide.md           # Layer 2: Navigation guide
  03-domain/business-logic.md           # Layer 3: Domain knowledge
  03-domain/api-specification.md        # Layer 3: API documentation
  04-workflow/contributing.md             # Layer 4: Development workflow
  04-workflow/troubleshooting.md          # Layer 4: Issue resolution
```
...
- [ ] Create 02-ai-context/ai-development-guide.md
- [ ] Create 02-ai-context/codebase-guide.md
