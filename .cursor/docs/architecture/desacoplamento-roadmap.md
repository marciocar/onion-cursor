...
├── .cursor/commands/engineer/work.md              (Alto)
├── .cursor/commands/engineer/pr.md                (Alto)
├── .cursor/commands/engineer/pre-pr.md            (Alto)
├── .cursor/commands/engineer/pr-update.md         (Alto)
├── .cursor/commands/product/task.md               (Médio)
├── .cursor/commands/product/presentation.md       (Baixo)
└── .cursor/commands/product/checklist-sync.md     (Baixo)
...
- [ ] Criar `.cursor/docs/architecture/desacoplamento-roadmap.md`
  - Este arquivo
...
- [ ] Criar arquivo único de padrão visual:
  - `.cursor/docs/strategies/visual-patterns.md`
...
- [ ] Revisar `.cursor/docs/clickup/clickup-*.md`
...
- [ ] Atualizar READMEs:
  - `.cursor/commands/engineer/README.md` - Remover referências MCP
  - `.cursor/commands/product/README.md` - Remover referências MCP
...
```bash
# 1. Criar estrutura
mkdir -p .cursor/docs/strategies

# 2. Adicionar arquivo de roadmap
git add .cursor/docs/architecture/desacoplamento-roadmap.md

# 3. Criar arquivo de wrappers
git add .cursor/utils/clickup-mcp-wrappers.md
