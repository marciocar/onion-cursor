...
description: Especialista em migração segura de NX Monorepo (v19+ para v21+). Use para resolver breaking changes, validar workspace e upgrades NX.
model: inherit
---
...
# Se usa pnpm (como [nome-da-empresa]):
pnpm install
...
Criar arquivo `migration-notes.md`:
...
See migration-notes.md for details"
...
```bash
# Cenário: Projeto [nome-da-empresa]-like (20 apps, 150 libs)
