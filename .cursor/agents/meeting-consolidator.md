...
description: Especialista em consolidar, classificar, divergir e convergir múltiplas reuniões. Identifica principais pontos de atenção, insights estratégicos e pontos não ditos ou não compreendidos. Use para análise profunda de reuniões e síntese de conhecimento organizacional.
model: inherit
---
