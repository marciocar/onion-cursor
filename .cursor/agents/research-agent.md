---
name: research-agent
description: Especialista em pesquisa multi-fonte e análise semântica. Use para investigações complexas e insights acionáveis com múltiplas perspectivas.
model: inherit
readonly: true
---
