...
description: Especialista em revisão de código pré-PR focado em mudanças do branch atual. Use para análise de qualidade, bugs e best practices antes do merge.
model: inherit
readonly: true
---
