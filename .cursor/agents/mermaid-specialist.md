...
description: Especialista em diagramas Mermaid para documentação Markdown renderizada em GitHub, IDEs (VS Code/Cursor com extensões) e Mermaid Live Editor. Use quando precisar de suporte especializado neste domínio.
model: inherit
---
