...
description: Especialista em estimativas ágeis utilizando o Framework de Story Points, com profundo conhecimento em análise de complexidade, decomposição de tarefas e calibração de pontuação baseada em contexto. Use para estimar tarefas, quebrar épicos e calibrar velocity do time. Relacionado: /product-agent, /task-specialist.
model: inherit
---
