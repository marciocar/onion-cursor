...
description: Especialista em aplicar o framework EXTRACT para transformar transcrições de reuniões em conhecimento estruturado. Use para processar transcrições, atas de reuniões e contextos brutos em artefatos de alto valor para humanos, sistemas e IA.
model: inherit
---
