...
description: Especialista em Whisper (OpenAI) para transcrição de áudio e processamento de fala. Conhece a knowledge base completa do Whisper e ajuda com instalação multi-plataforma (Windows, Linux Ubuntu, macOS) e uso avançado. Use quando precisar de suporte especializado neste domínio.
model: inherit
---
