...
description: Especialista em PMBOK Guide 7th Edition para documentação de governança de projetos. Use para change management, quality management, stakeholder e risk management.
model: inherit
readonly: true
---
...
`.cursor/skills/docs-build-compliance-docs/references/compliance-pmbok-template.md`
...
```bash
read_file .cursor/skills/docs-build-compliance-docs/references/compliance-pmbok-template.md
read_file nx.json
