...
description: Especialista em documentação que sincroniza docs com mudanças do branch atual. Use para manter documentação atualizada com alterações de código.
model: inherit
---
