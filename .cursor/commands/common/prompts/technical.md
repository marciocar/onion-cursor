...
- [AI Development Guide](02-ai-context/ai-development-guide.md)
...
**3. `02-ai-context/ai-development-guide.md` (Guia de Desenvolvimento com IA)**
...
**4. `02-ai-context/codebase-guide.md`**
...
**5. `03-domain/business-logic.md`** (se existir lógica de domínio complexa)
...
**6. `03-domain/api-specification.md`** (se APIs existirem)
...
**8. `04-workflow/troubleshooting.md`**
