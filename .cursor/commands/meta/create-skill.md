...
description: |
  ...
  @agent-skills-specialist. Padrão Onion: skills em .cursor/skills/ (Claude Code-nativo).
...
Ler `argumento-do-usuario` e determinar:
...
- **Docs oficiais**: https://cursor.com/docs/skills (Claude Code) | https://agentskills.io/specification (spec aberta)
