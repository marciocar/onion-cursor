...
### 1. `/product/task`
**Arquivo**: `.claude/commands/product/task.md`
...
### 2. `/product/feature`
**Arquivo**: `.claude/commands/product/feature.md`
...
- **Documentação oficial**: `.claude/docs/clickup/clickup-formatting.md`
- **Estratégia de auto-update**: `.claude/docs/clickup/clickup-auto-update-strategy.md`
- **Formatter de comments**: `.claude/docs/clickup/clickup-comment-formatter.md`
